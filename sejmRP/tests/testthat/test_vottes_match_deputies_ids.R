test_that("result of function", {
  expect_equal(class(votes_match_deputies_ids("sejmrp", "reader", "qux94874", "192.168.137.38",
...
test_that("columns of table", {
  expect_equal(ncol(votes_match_deputies_ids("sejmrp", "reader", "qux94874", "192.168.137.38",
...
test_that("rows of table", {
  expect_more_than(nrow(votes_match_deputies_ids("sejmrp", "reader", "qux94874", "192.168.137.38",
