...
test_that("length", {
  expect_more_than(length(votings_get_votings_links("http://www.sejm.gov.pl/Sejm7.nsf/",
    "http://www.sejm.gov.pl/Sejm7.nsf/agent.xsp?symbol=listaglos&IdDnia=1181")), 0)
})